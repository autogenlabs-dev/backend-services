from pydantic_settin21:    stripe_secret_key: str = "sk_test_your_stripe_secret_key"s import BaseSettings
from typing import List
import os


class Settings(BaseSettings):    # Database
    ...
    # CORS
    backend_cors_origins: List[str] = ["http://localhost:3000", "http://localhost:8080"]    # OAuth
